...
import { createPaymentAsync } from "../../redux/payments/paymentsThunk";
import { postImageAsync } from "../../redux/image/imageThunk";

export default function PaymentCreate() {
  const { errors, loading } = useSelector((state) => state.payments);
  const { image: paymentIcon, loading: loadingImage } = useSelector(
    (state) => state.image,
  );
          ...
          <form onSubmit={storeTalent} className="container-xl">
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title">New Payment Method</h5>
                <button
                  type="button"
                  className="btn-close"
                    ...
                    <div className="d-flex align-items-center gap-x-2">
                      <div className="col-6 col-md-3 mb-3">
                        ...
                        <div
                          ...
                          style={{
                            height: "120px",
                            backgroundColor: paymentIcon
                              ? "transparent"
                              : "#e9ecef",
                            backgroundImage: paymentIcon
                              ? `url(${import.meta.env.VITE_APP_IMAGEBASEURL}/${paymentIcon.name})`
                              : "none",
